...
public class App {
	public static void main(String[] args) {
		 ...
		 for(int i=0;i<10;i++) {
		 r1.agregarTemperatura(new Temperatura(generadorAleatorio.nextDouble()*50,Escala.CELCIUS));
		 }

		 for(int i=0;i<10;i++) {
		 r2.agregarTemperatura(new Temperatura(generadorAleatorio.nextDouble()*105,Escala.FAHRENHEIT));
		 }
